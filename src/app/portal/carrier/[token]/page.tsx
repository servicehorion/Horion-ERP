...
import { PortalCarrierForm } from "@/components/logistics/portal-carrier-form";
...
export default async function CarrierPortalPage({
  ...
  if (!portal || portal.role !== "CARRIER" || (portal.expiresAt && portal.expiresAt < new Date())) {
    return (
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Portail transporteur</h1>
      ...
      <div className="rounded-lg border p-4">
        <h2 className="font-semibold mb-3">Envoyer une mise a jour</h2>
        <PortalCarrierForm token={token} />
      </div>
    </div>
  );
}
