...
export function PipelineIntentDialog({
  contactId,
  demoMode,
}: {
  contactId: string;
  ...
  async function onSubmit(values: FormValues) {
    if (demoMode) {
      toast("Mode demo : intention non enregistree.");
      setOpen(false);
      form.reset();
      return;
    }
    setSubmitting(true);
    try {
      const result = await createPipelineIntent(contactId, {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Enregistrez une intention de commande et son potentiel
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
